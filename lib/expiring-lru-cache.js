...
Cache.prototype.set = function set(key, value) {
  ...
  // Limitation: Currently it is possible for `set` to drop a non-expired
  // item when there are expired items sitting in the cache. To properly
  // handle that we'd want to override the lru-cache logic.
